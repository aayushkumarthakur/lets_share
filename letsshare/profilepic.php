...
$folder = "profile/".$row['username']."/".$filename;
move_uploaded_file($tempname,$folder);
$sql = "UPDATE registertable SET profilepic='$folder' WHERE email='$user'";
...
.temp:hover{
    ...
    <body>
         <div class="row"><center>
                                        <div class="topnav">
  <a href="profile.php" style="padding-right:0;"><i class="material-icons" style="font-size:24px;">arrow_back</i></a><a><b style="color:grey;font-family:google">Daero</b> <b style="font-family:google">Let's Share</b></a>
 ...
 <a class=nav1 href="profile.php" style="float:right;">Profile</a>
        ...
        <center><br><br><br><br>
                ...
                <form action="" method="post" enctype="multipart/form-data"><br>
                    ...
                    <center><label for="fileid"><div class="temp">CHOOSE</div></label></center>
                    <br>
                    <input class="temp" type="submit" name="submit" value="UPLOAD">
                    <br><br><br>
