                ...
                if($res==1){
                    ...
                    if($row['email']==$email && $row['password']==$password){
                       ...
                       setcookie("email",$email,time()+86400*10);
                        ...
                        header("location:orglogin.php?inf=wrong102");
                    } 
            } else {
                header("location:orglogin.php?inf=account103");
            }
               mysqli_close($con);       
            } else {
...
<div class="topnav">
    ...
    <div class="body">
         <div class="group">
<span class="cont">Organisation Log In</span>
<br><BR><BR><BR>
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">        
         ...
         <?php
             ...
             if($get=="login101"){
                 ...
                 echo "Account Doesn't Exist <a href='orgsignup.php'  style=\"text-decoration: none;color:green;\" >Signup</a>";
             } 
                 else if($get==""){
